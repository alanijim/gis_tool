...
class SlaacGatheringToolRemoveNode(QgsMapTool):
    ...
    def canvasPressEvent(self,event):
        ...
        node_id = my_canvas.getSelectedNode(self.canvas, layer, pointMap)
        if not node_id:
            QMessageBox.information(None, "Error:", "Please select a node" ) 
            return
        #try:
        ...
        try:
            my_map.removeIsolatedNode(uri,node_id)
            my_canvas.refreshNodeLayer(self.canvas)
